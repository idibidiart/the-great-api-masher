...
These principles are written for GraphQL but they apply to any stateless client-server interaction, not just GraphQL, when consistent reads/writes are expected, in an transactional context.  
