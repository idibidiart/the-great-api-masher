...
export default class MockModelB extends GraphQLModel {
  ...
  getData() {
    return Promise.resolve("this is test data from data source Mock B")
  }  
  ...
  throwError(
    {
      statusCode = 500,
      message = 'Mock B API: Something went wrong.',
      targetEndpoint = null,
    },
    customErrorData = {},
  ) {
